...
import type { TrokkyCore, ContentSchema, UserRole } from '../../core/index.js'
import type { RoutesConfig, HttpRequest, HttpResponse } from '../../routes/index.js'
...
// core is optional here because TrokkyExpress.create() sets it during initialization
export interface ExpressIntegrationConfig extends Omit<RoutesConfig, 'core'> {
  // Core configuration (set during TrokkyExpress.create())
  core?: TrokkyCore
