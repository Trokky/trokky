...
import { TrokkyRoutes, type RoutesConfig } from '../../routes/index.js'
...
export class TrokkyExpress {
  ...
  constructor(config: ExpressIntegrationConfig) {
    ...
    this.routes = new TrokkyRoutes(config as RoutesConfig)
  ...
  private static async createDataAdapter(
    ...
    const { createAdapter } = await import('../../core/index.js')
