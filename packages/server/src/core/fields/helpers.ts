 ...
 */
function normalizeConditional<T>(
  value: T | ((context: FieldContext) => T | Promise<T>) | undefined
): ((context: FieldContext) => T | Promise<T>) | undefined {
...
export class FieldUtils {
   ...
   */
  static async isHidden(field: FieldDefinition, context: FieldContext): Promise<boolean> {
   ...
   */
  static async isReadOnly(field: FieldDefinition, context: FieldContext): Promise<boolean> {
   ...
   */
  static async isDisabled(field: FieldDefinition, context: FieldContext): Promise<boolean> {
   ...
   */
  static async isRequired(field: FieldDefinition, context: FieldContext): Promise<boolean> {
   ...
   */
  static async getDefaultValue(field: FieldDefinition, context: FieldContext): Promise<any> {
  ...
  static createMockContext(overrides: Partial<FieldContext> = {}): FieldContext {
    return {
      ...
      getFieldConfig: (path: string) => undefined,
      errors: [],
      touched: {},
      isStudio: true,
      isPreview: false,
...
export class Rule {
  ...
  custom(validate: (value: any, context: FieldContext) => boolean | Promise<boolean>, message?: string) {
