 ...
 */
export async function createImageProcessor(config) {
    switch (config.type) {
        case 'none': {
        ...
        case 'sharp': {
            ...
            try {
                ...
                throw new Error(`Failed to load Sharp processor: ${error instanceof Error ? error.message : String(error)}\n\n` +
        ...
        // }
        case 'imagekit': {
            throw new Error('ImageKit processor is not yet implemented.\n' +
                'Use processor: "none" for edge environments or "sharp" for Node.js environments.');
        }
        case 'imgix': {
            throw new Error('Imgix processor is not yet implemented.\n' +
                'Use processor: "none" for edge environments or "sharp" for Node.js environments.');
        }
        default:
